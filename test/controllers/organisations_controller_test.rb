...
class OrganisationsControllerTest < ActionController::TestCase
  ...
  test "should create organisation" do
    assert_difference('Organisation.count') do
      post :create, organisation: { description: @organisation.description, name: @organisation.name, theboss: @organisation.theboss }
    end
  ...
  test "should update organisation" do
    patch :update, id: @organisation, organisation: { description: @organisation.description, name: @organisation.name, theboss: @organisation.theboss }
    assert_redirected_to organisation_path(assigns(:organisation))
  end
